...
?>
<?php if ($t201_users_list->EmployeeID->Visible) { // EmployeeID ?>
	<?php if ($t201_users_list->SortUrl($t201_users_list->EmployeeID) == "") { ?>
		<th data-name="EmployeeID" class="<?php echo $t201_users_list->EmployeeID->headerCellClass() ?>"><div id="elh_t201_users_EmployeeID" class="t201_users_EmployeeID"><div class="ew-table-header-caption"><?php echo $t201_users_list->EmployeeID->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="EmployeeID" class="<?php echo $t201_users_list->EmployeeID->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->EmployeeID) ?>', 2);"><div id="elh_t201_users_EmployeeID" class="t201_users_EmployeeID">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $t201_users_list->EmployeeID->caption() ?></span><span class="ew-table-header-sort"><?php if ($t201_users_list->EmployeeID->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($t201_users_list->EmployeeID->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($t201_users_list->LastName->Visible) { // LastName ?>
	...
	<?php } else { ?>
		<th data-name="LastName" class="<?php echo $t201_users_list->LastName->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->LastName) ?>', 2);"><div id="elh_t201_users_LastName" class="t201_users_LastName">
...
<?php if ($t201_users_list->FirstName->Visible) { // FirstName ?>
	...
	<?php } else { ?>
		<th data-name="FirstName" class="<?php echo $t201_users_list->FirstName->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->FirstName) ?>', 2);"><div id="elh_t201_users_FirstName" class="t201_users_FirstName">
...
<?php if ($t201_users_list->Title->Visible) { // Title ?>
	...
	<?php } else { ?>
		<th data-name="Title" class="<?php echo $t201_users_list->Title->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->Title) ?>', 2);"><div id="elh_t201_users_Title" class="t201_users_Title">
...
<?php if ($t201_users_list->TitleOfCourtesy->Visible) { // TitleOfCourtesy ?>
	...
	<?php } else { ?>
		<th data-name="TitleOfCourtesy" class="<?php echo $t201_users_list->TitleOfCourtesy->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->TitleOfCourtesy) ?>', 2);"><div id="elh_t201_users_TitleOfCourtesy" class="t201_users_TitleOfCourtesy">
...
<?php if ($t201_users_list->BirthDate->Visible) { // BirthDate ?>
	...
	<?php } else { ?>
		<th data-name="BirthDate" class="<?php echo $t201_users_list->BirthDate->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->BirthDate) ?>', 2);"><div id="elh_t201_users_BirthDate" class="t201_users_BirthDate">
...
<?php if ($t201_users_list->HireDate->Visible) { // HireDate ?>
	...
	<?php } else { ?>
		<th data-name="HireDate" class="<?php echo $t201_users_list->HireDate->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->HireDate) ?>', 2);"><div id="elh_t201_users_HireDate" class="t201_users_HireDate">
...
<?php if ($t201_users_list->Address->Visible) { // Address ?>
	...
	<?php } else { ?>
		<th data-name="Address" class="<?php echo $t201_users_list->Address->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->Address) ?>', 2);"><div id="elh_t201_users_Address" class="t201_users_Address">
...
<?php if ($t201_users_list->City->Visible) { // City ?>
	...
	<?php } else { ?>
		<th data-name="City" class="<?php echo $t201_users_list->City->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->City) ?>', 2);"><div id="elh_t201_users_City" class="t201_users_City">
...
<?php if ($t201_users_list->Region->Visible) { // Region ?>
	...
	<?php } else { ?>
		<th data-name="Region" class="<?php echo $t201_users_list->Region->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->Region) ?>', 2);"><div id="elh_t201_users_Region" class="t201_users_Region">
...
<?php if ($t201_users_list->PostalCode->Visible) { // PostalCode ?>
	...
	<?php } else { ?>
		<th data-name="PostalCode" class="<?php echo $t201_users_list->PostalCode->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->PostalCode) ?>', 2);"><div id="elh_t201_users_PostalCode" class="t201_users_PostalCode">
...
<?php if ($t201_users_list->Country->Visible) { // Country ?>
	...
	<?php } else { ?>
		<th data-name="Country" class="<?php echo $t201_users_list->Country->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->Country) ?>', 2);"><div id="elh_t201_users_Country" class="t201_users_Country">
...
<?php if ($t201_users_list->HomePhone->Visible) { // HomePhone ?>
	...
	<?php } else { ?>
		<th data-name="HomePhone" class="<?php echo $t201_users_list->HomePhone->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->HomePhone) ?>', 2);"><div id="elh_t201_users_HomePhone" class="t201_users_HomePhone">
...
<?php if ($t201_users_list->Extension->Visible) { // Extension ?>
	...
	<?php } else { ?>
		<th data-name="Extension" class="<?php echo $t201_users_list->Extension->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->Extension) ?>', 2);"><div id="elh_t201_users_Extension" class="t201_users_Extension">
...
<?php if ($t201_users_list->_Email->Visible) { // Email ?>
	...
	<?php } else { ?>
		<th data-name="_Email" class="<?php echo $t201_users_list->_Email->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->_Email) ?>', 2);"><div id="elh_t201_users__Email" class="t201_users__Email">
...
<?php if ($t201_users_list->Photo->Visible) { // Photo ?>
	...
	<?php } else { ?>
		<th data-name="Photo" class="<?php echo $t201_users_list->Photo->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->Photo) ?>', 2);"><div id="elh_t201_users_Photo" class="t201_users_Photo">
...
<?php if ($t201_users_list->ReportsTo->Visible) { // ReportsTo ?>
	...
	<?php } else { ?>
		<th data-name="ReportsTo" class="<?php echo $t201_users_list->ReportsTo->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->ReportsTo) ?>', 2);"><div id="elh_t201_users_ReportsTo" class="t201_users_ReportsTo">
...
<?php if ($t201_users_list->Password->Visible) { // Password ?>
	...
	<?php } else { ?>
		<th data-name="Password" class="<?php echo $t201_users_list->Password->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->Password) ?>', 2);"><div id="elh_t201_users_Password" class="t201_users_Password">
	...
	<?php } ?>
<?php } ?>
<?php if ($t201_users_list->_UserLevel->Visible) { // UserLevel ?>
	<?php if ($t201_users_list->SortUrl($t201_users_list->_UserLevel) == "") { ?>
		<th data-name="_UserLevel" class="<?php echo $t201_users_list->_UserLevel->headerCellClass() ?>"><div id="elh_t201_users__UserLevel" class="t201_users__UserLevel"><div class="ew-table-header-caption"><?php echo $t201_users_list->_UserLevel->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="_UserLevel" class="<?php echo $t201_users_list->_UserLevel->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->_UserLevel) ?>', 2);"><div id="elh_t201_users__UserLevel" class="t201_users__UserLevel">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $t201_users_list->_UserLevel->caption() ?></span><span class="ew-table-header-sort"><?php if ($t201_users_list->_UserLevel->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($t201_users_list->_UserLevel->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($t201_users_list->Username->Visible) { // Username ?>
	...
	<?php } else { ?>
		<th data-name="Username" class="<?php echo $t201_users_list->Username->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->Username) ?>', 2);"><div id="elh_t201_users_Username" class="t201_users_Username">
...
<?php if ($t201_users_list->Activated->Visible) { // Activated ?>
	...
	<?php } else { ?>
		<th data-name="Activated" class="<?php echo $t201_users_list->Activated->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t201_users_list->SortUrl($t201_users_list->Activated) ?>', 2);"><div id="elh_t201_users_Activated" class="t201_users_Activated">
...
?>
	<?php if ($t201_users_list->EmployeeID->Visible) { // EmployeeID ?>
		<td data-name="EmployeeID" <?php echo $t201_users_list->EmployeeID->cellAttributes() ?>>
<span id="el<?php echo $t201_users_list->RowCount ?>_t201_users_EmployeeID">
<span<?php echo $t201_users_list->EmployeeID->viewAttributes() ?>><?php echo $t201_users_list->EmployeeID->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($t201_users_list->LastName->Visible) { // LastName ?>
...
<span<?php echo $t201_users_list->Password->viewAttributes() ?>><?php echo $t201_users_list->Password->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($t201_users_list->_UserLevel->Visible) { // UserLevel ?>
		<td data-name="_UserLevel" <?php echo $t201_users_list->_UserLevel->cellAttributes() ?>>
<span id="el<?php echo $t201_users_list->RowCount ?>_t201_users__UserLevel">
<span<?php echo $t201_users_list->_UserLevel->viewAttributes() ?>><?php echo $t201_users_list->_UserLevel->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($t201_users_list->Username->Visible) { // Username ?>
