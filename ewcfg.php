...
$CONFIG = [
	...
	"RANDOM_KEY" => 'tafS1BJ3whcWpDJ2', // Random key for encryption
	...
	"PROJECT_ID" => "{E1C6E322-15B9-474C-85CF-A99378A9BC2B}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3307, "user" => "root", "pass" => "admin", "db" => "db_simasset1"]
	],
	...
	"AUDIT_TRAIL_TABLE_NAME" => "t204_audittrail", // Audit trail table name
	"AUDIT_TRAIL_TABLE_VAR" => "t204_audittrail", // Audit trail table var
	...
	"USER_LEVEL_DBID" => "DB",
	"USER_LEVEL_TABLE" => "`t202_userlevels`",
	...
	"USER_LEVEL_PRIV_TABLE" => "`t203_userlevelpermissions`",
	...
	// User table filters
	"USER_TABLE_DBID" => "DB",
	"USER_TABLE" => "`t201_users`",
	"USER_NAME_FILTER" => "(`Username` = '%u')",
	"USER_ID_FILTER" => "(`EmployeeID` = %u)",
	"USER_EMAIL_FILTER" => "",
