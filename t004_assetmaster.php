...
<?php } ?>
<?php if ($t004_asset->type_id->Visible) { // type_id ?>
		<tr id="r_type_id">
			<td class="<?php echo $t004_asset->TableLeftColumnClass ?>"><?php echo $t004_asset->type_id->caption() ?></td>
			<td <?php echo $t004_asset->type_id->cellAttributes() ?>>
<span id="el_t004_asset_type_id">
<span<?php echo $t004_asset->type_id->viewAttributes() ?>><?php echo $t004_asset->type_id->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<?php } ?>
<?php if ($t004_asset->brand_id->Visible) { // brand_id ?>
		<tr id="r_brand_id">
			<td class="<?php echo $t004_asset->TableLeftColumnClass ?>"><?php echo $t004_asset->brand_id->caption() ?></td>
			<td <?php echo $t004_asset->brand_id->cellAttributes() ?>>
<span id="el_t004_asset_brand_id">
<span<?php echo $t004_asset->brand_id->viewAttributes() ?>><?php echo $t004_asset->brand_id->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<?php } ?>
<?php if ($t004_asset->location_id->Visible) { // location_id ?>
		<tr id="r_location_id">
			<td class="<?php echo $t004_asset->TableLeftColumnClass ?>"><?php echo $t004_asset->location_id->caption() ?></td>
			<td <?php echo $t004_asset->location_id->cellAttributes() ?>>
<span id="el_t004_asset_location_id">
<span<?php echo $t004_asset->location_id->viewAttributes() ?>><?php echo $t004_asset->location_id->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
