...
<div class="custom-control custom-checkbox d-inline-block">
	<input type="checkbox" class="custom-control-input" data-table="t201_users" data-field="x_Activated" name="x_Activated[]" id="x_Activated[]_725311" value="1"<?php echo $selwrk ?><?php echo $t201_users_edit->Activated->editAttributes() ?>>
	<label class="custom-control-label" for="x_Activated[]_725311"></label>
</div>
</span>
