...
loadjs.ready("head", function() {
	...
	ft201_usersedit.validate = function() {
		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php if ($t201_users_edit->EmployeeID->Required) { ?>
				elm = this.getElements("x" + infix + "_EmployeeID");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $t201_users_edit->EmployeeID->caption(), $t201_users_edit->EmployeeID->RequiredErrorMessage)) ?>");
			<?php } ?>
			...
			<?php } ?>
			<?php if ($t201_users_edit->_UserLevel->Required) { ?>
				elm = this.getElements("x" + infix + "__UserLevel");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $t201_users_edit->_UserLevel->caption(), $t201_users_edit->_UserLevel->RequiredErrorMessage)) ?>");
			<?php } ?>
			...
			<?php } ?>
				elm = this.getElements("x" + infix + "_sekolah_id");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($t201_users_edit->sekolah_id->errorMessage()) ?>");
			...
			<?php } ?>
				elm = this.getElements("x" + infix + "_tahunajaran_id");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($t201_users_edit->tahunajaran_id->errorMessage()) ?>");
			...
			<?php } ?>
				elm = this.getElements("x" + infix + "_kelas_id");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($t201_users_edit->kelas_id->errorMessage()) ?>");
			...
			<?php } ?>
				elm = this.getElements("x" + infix + "_semester_id");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($t201_users_edit->semester_id->errorMessage()) ?>");
	...
	ft201_usersedit.lists["x__UserLevel"] = <?php echo $t201_users_edit->_UserLevel->Lookup->toClientList($t201_users_edit) ?>;
	ft201_usersedit.lists["x__UserLevel"].options = <?php echo JsonEncode($t201_users_edit->_UserLevel->lookupOptions()) ?>;
...
<?php if ($t201_users_edit->EmployeeID->Visible) { // EmployeeID ?>
	<div id="r_EmployeeID" class="form-group row">
		<label id="elh_t201_users_EmployeeID" class="<?php echo $t201_users_edit->LeftColumnClass ?>"><?php echo $t201_users_edit->EmployeeID->caption() ?><?php echo $t201_users_edit->EmployeeID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t201_users_edit->RightColumnClass ?>"><div <?php echo $t201_users_edit->EmployeeID->cellAttributes() ?>>
<span id="el_t201_users_EmployeeID">
<span<?php echo $t201_users_edit->EmployeeID->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($t201_users_edit->EmployeeID->EditValue)) ?>"></span>
</span>
...
<?php echo $t201_users_edit->EmployeeID->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<input type="text" data-table="t201_users" data-field="x_LastName" name="x_LastName" id="x_LastName" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($t201_users_edit->LastName->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->LastName->EditValue ?>"<?php echo $t201_users_edit->LastName->editAttributes() ?>>
</span>
...
<input type="text" data-table="t201_users" data-field="x_FirstName" name="x_FirstName" id="x_FirstName" size="30" maxlength="10" placeholder="<?php echo HtmlEncode($t201_users_edit->FirstName->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->FirstName->EditValue ?>"<?php echo $t201_users_edit->FirstName->editAttributes() ?>>
</span>
...
<input type="text" data-table="t201_users" data-field="x_Title" name="x_Title" id="x_Title" size="30" maxlength="30" placeholder="<?php echo HtmlEncode($t201_users_edit->Title->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->Title->EditValue ?>"<?php echo $t201_users_edit->Title->editAttributes() ?>>
</span>
...
<input type="text" data-table="t201_users" data-field="x_TitleOfCourtesy" name="x_TitleOfCourtesy" id="x_TitleOfCourtesy" size="30" maxlength="25" placeholder="<?php echo HtmlEncode($t201_users_edit->TitleOfCourtesy->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->TitleOfCourtesy->EditValue ?>"<?php echo $t201_users_edit->TitleOfCourtesy->editAttributes() ?>>
</span>
...
<input type="text" data-table="t201_users" data-field="x_BirthDate" name="x_BirthDate" id="x_BirthDate" maxlength="19" placeholder="<?php echo HtmlEncode($t201_users_edit->BirthDate->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->BirthDate->EditValue ?>"<?php echo $t201_users_edit->BirthDate->editAttributes() ?>>
...
<input type="text" data-table="t201_users" data-field="x_HireDate" name="x_HireDate" id="x_HireDate" maxlength="19" placeholder="<?php echo HtmlEncode($t201_users_edit->HireDate->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->HireDate->EditValue ?>"<?php echo $t201_users_edit->HireDate->editAttributes() ?>>
...
<input type="text" data-table="t201_users" data-field="x_Address" name="x_Address" id="x_Address" size="30" maxlength="60" placeholder="<?php echo HtmlEncode($t201_users_edit->Address->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->Address->EditValue ?>"<?php echo $t201_users_edit->Address->editAttributes() ?>>
</span>
...
<input type="text" data-table="t201_users" data-field="x_City" name="x_City" id="x_City" size="30" maxlength="15" placeholder="<?php echo HtmlEncode($t201_users_edit->City->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->City->EditValue ?>"<?php echo $t201_users_edit->City->editAttributes() ?>>
</span>
...
<input type="text" data-table="t201_users" data-field="x_Region" name="x_Region" id="x_Region" size="30" maxlength="15" placeholder="<?php echo HtmlEncode($t201_users_edit->Region->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->Region->EditValue ?>"<?php echo $t201_users_edit->Region->editAttributes() ?>>
</span>
...
<input type="text" data-table="t201_users" data-field="x_PostalCode" name="x_PostalCode" id="x_PostalCode" size="30" maxlength="10" placeholder="<?php echo HtmlEncode($t201_users_edit->PostalCode->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->PostalCode->EditValue ?>"<?php echo $t201_users_edit->PostalCode->editAttributes() ?>>
</span>
...
<input type="text" data-table="t201_users" data-field="x_Country" name="x_Country" id="x_Country" size="30" maxlength="15" placeholder="<?php echo HtmlEncode($t201_users_edit->Country->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->Country->EditValue ?>"<?php echo $t201_users_edit->Country->editAttributes() ?>>
</span>
...
<input type="text" data-table="t201_users" data-field="x_HomePhone" name="x_HomePhone" id="x_HomePhone" size="30" maxlength="24" placeholder="<?php echo HtmlEncode($t201_users_edit->HomePhone->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->HomePhone->EditValue ?>"<?php echo $t201_users_edit->HomePhone->editAttributes() ?>>
</span>
...
<input type="text" data-table="t201_users" data-field="x_Extension" name="x_Extension" id="x_Extension" size="30" maxlength="4" placeholder="<?php echo HtmlEncode($t201_users_edit->Extension->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->Extension->EditValue ?>"<?php echo $t201_users_edit->Extension->editAttributes() ?>>
</span>
...
<input type="text" data-table="t201_users" data-field="x__Email" name="x__Email" id="x__Email" size="30" maxlength="30" placeholder="<?php echo HtmlEncode($t201_users_edit->_Email->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->_Email->EditValue ?>"<?php echo $t201_users_edit->_Email->editAttributes() ?>>
</span>
...
<input type="text" data-table="t201_users" data-field="x_Photo" name="x_Photo" id="x_Photo" size="30" maxlength="255" placeholder="<?php echo HtmlEncode($t201_users_edit->Photo->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->Photo->EditValue ?>"<?php echo $t201_users_edit->Photo->editAttributes() ?>>
</span>
...
<textarea data-table="t201_users" data-field="x_Notes" name="x_Notes" id="x_Notes" cols="35" rows="4" placeholder="<?php echo HtmlEncode($t201_users_edit->Notes->getPlaceHolder()) ?>"<?php echo $t201_users_edit->Notes->editAttributes() ?>><?php echo $t201_users_edit->Notes->EditValue ?></textarea>
</span>
...
<input type="text" data-table="t201_users" data-field="x_ReportsTo" name="x_ReportsTo" id="x_ReportsTo" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($t201_users_edit->ReportsTo->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->ReportsTo->EditValue ?>"<?php echo $t201_users_edit->ReportsTo->editAttributes() ?>>
</span>
...
<input type="text" data-table="t201_users" data-field="x_Password" name="x_Password" id="x_Password" size="30" maxlength="50" placeholder="<?php echo HtmlEncode($t201_users_edit->Password->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->Password->EditValue ?>"<?php echo $t201_users_edit->Password->editAttributes() ?>>
</span>
<?php echo $t201_users_edit->Password->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t201_users_edit->_UserLevel->Visible) { // UserLevel ?>
	<div id="r__UserLevel" class="form-group row">
		<label id="elh_t201_users__UserLevel" for="x__UserLevel" class="<?php echo $t201_users_edit->LeftColumnClass ?>"><?php echo $t201_users_edit->_UserLevel->caption() ?><?php echo $t201_users_edit->_UserLevel->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t201_users_edit->RightColumnClass ?>"><div <?php echo $t201_users_edit->_UserLevel->cellAttributes() ?>>
<?php if (!$Security->isAdmin() && $Security->isLoggedIn()) { // Non system admin ?>
<span id="el_t201_users__UserLevel">
<input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($t201_users_edit->_UserLevel->EditValue)) ?>">
</span>
<?php } else { ?>
<span id="el_t201_users__UserLevel">
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="t201_users" data-field="x__UserLevel" data-value-separator="<?php echo $t201_users_edit->_UserLevel->displayValueSeparatorAttribute() ?>" id="x__UserLevel" name="x__UserLevel"<?php echo $t201_users_edit->_UserLevel->editAttributes() ?>>
			<?php echo $t201_users_edit->_UserLevel->selectOptionListHtml("x__UserLevel") ?>
		</select>
</div>
<?php echo $t201_users_edit->_UserLevel->Lookup->getParamTag($t201_users_edit, "p_x__UserLevel") ?>
</span>
<?php } ?>
<?php echo $t201_users_edit->_UserLevel->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<input type="text" data-table="t201_users" data-field="x_Username" name="x_Username" id="x_Username" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($t201_users_edit->Username->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->Username->EditValue ?>"<?php echo $t201_users_edit->Username->editAttributes() ?>>
</span>
...
<div class="custom-control custom-checkbox d-inline-block">
	<input type="checkbox" class="custom-control-input" data-table="t201_users" data-field="x_Activated" name="x_Activated[]" id="x_Activated[]_689323" value="1"<?php echo $selwrk ?><?php echo $t201_users_edit->Activated->editAttributes() ?>>
	<label class="custom-control-label" for="x_Activated[]_689323"></label>
</div>
</span>
...
<textarea data-table="t201_users" data-field="x_Profile" name="x_Profile" id="x_Profile" cols="35" rows="4" placeholder="<?php echo HtmlEncode($t201_users_edit->Profile->getPlaceHolder()) ?>"<?php echo $t201_users_edit->Profile->editAttributes() ?>><?php echo $t201_users_edit->Profile->EditValue ?></textarea>
</span>
...
<input type="text" data-table="t201_users" data-field="x_sekolah_id" name="x_sekolah_id" id="x_sekolah_id" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($t201_users_edit->sekolah_id->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->sekolah_id->EditValue ?>"<?php echo $t201_users_edit->sekolah_id->editAttributes() ?>>
</span>
...
<input type="text" data-table="t201_users" data-field="x_tahunajaran_id" name="x_tahunajaran_id" id="x_tahunajaran_id" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($t201_users_edit->tahunajaran_id->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->tahunajaran_id->EditValue ?>"<?php echo $t201_users_edit->tahunajaran_id->editAttributes() ?>>
</span>
...
<input type="text" data-table="t201_users" data-field="x_kelas_id" name="x_kelas_id" id="x_kelas_id" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($t201_users_edit->kelas_id->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->kelas_id->EditValue ?>"<?php echo $t201_users_edit->kelas_id->editAttributes() ?>>
</span>
...
<input type="text" data-table="t201_users" data-field="x_semester_id" name="x_semester_id" id="x_semester_id" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($t201_users_edit->semester_id->getPlaceHolder()) ?>" value="<?php echo $t201_users_edit->semester_id->EditValue ?>"<?php echo $t201_users_edit->semester_id->editAttributes() ?>>
</span>
