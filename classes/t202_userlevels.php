...
/**
 * Table class for t202_userlevels
 */
class t202_userlevels extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't202_userlevels';
		$this->TableName = 't202_userlevels';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t202_userlevels`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new DbField('t202_userlevels', 't202_userlevels', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, 11, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// userlevelname
		$this->userlevelname = new DbField('t202_userlevels', 't202_userlevels', 'x_userlevelname', 'userlevelname', '`userlevelname`', '`userlevelname`', 200, 255, -1, FALSE, '`userlevelname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`t202_userlevels`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "t202_userlevelslist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "t202_userlevelsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t202_userlevelsadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("t202_userlevelsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t202_userlevelsview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "t202_userlevelsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "t202_userlevelsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t202_userlevelsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t202_userlevelsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t202_userlevelsdelete.php", $this->getUrlParm());
	}
