 ...
 * Page class
 */
class t202_userlevels_view extends t202_userlevels
{
	...
	// Page object name
	public $PageObjName = "t202_userlevels_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("userlevelid") !== NULL) {
				...
				$returnUrl = "t202_userlevelslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t202_userlevelslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t202_userlevelslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
