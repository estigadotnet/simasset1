 ...
 * Page class
 */
class t006_assetdepreciation_view extends t006_assetdepreciation
{
	...
	// Page object name
	public $PageObjName = "t006_assetdepreciation_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			...
			$returnUrl = "t006_assetdepreciationlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
