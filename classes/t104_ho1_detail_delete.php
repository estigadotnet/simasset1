 ...
 * Page class
 */
class t104_ho1_detail_delete extends t104_ho1_detail
{
	...
	// Page object name
	public $PageObjName = "t104_ho1_detail_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t104_ho1_detaillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t104_ho1_detaillist.php"); // Return to list
			}
		}
	}
