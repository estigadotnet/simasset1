 ...
 * Page class
 */
class t006_assetdepreciation_add extends t006_assetdepreciation
{
	...
	// Page object name
	public $PageObjName = "t006_assetdepreciation_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t006_assetdepreciationview.php")
