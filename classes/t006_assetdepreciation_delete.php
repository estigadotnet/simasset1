 ...
 * Page class
 */
class t006_assetdepreciation_delete extends t006_assetdepreciation
{
	...
	// Page object name
	public $PageObjName = "t006_assetdepreciation_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t006_assetdepreciationlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t006_assetdepreciationlist.php"); // Return to list
			}
		}
	}
