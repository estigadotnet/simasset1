...
class t004_asset_list extends t004_asset
{
	...
	protected function advancedSearchWhere($default = FALSE)
	{
		...
		$this->buildSearchSql($where, $this->DepreciationAmount, $default, FALSE); // DepreciationAmount
		$this->buildSearchSql($where, $this->DepreciationYtd, $default, FALSE); // DepreciationYtd
		$this->buildSearchSql($where, $this->NetBookValue, $default, FALSE); // NetBookValue
		...
		if (!$default && $this->Command == "search") {
			...
			$this->DepreciationAmount->AdvancedSearch->save(); // DepreciationAmount
			$this->DepreciationYtd->AdvancedSearch->save(); // DepreciationYtd
			$this->NetBookValue->AdvancedSearch->save(); // NetBookValue
	...
	protected function checkSearchParms()
	{
		...
		if ($this->ProcurementCurrentCost->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->DepreciationAmount->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->DepreciationYtd->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->NetBookValue->AdvancedSearch->issetSession())
			return TRUE;
	...
	protected function resetAdvancedSearchParms()
	{
		...
		$this->DepreciationAmount->AdvancedSearch->unsetSession();
		$this->DepreciationYtd->AdvancedSearch->unsetSession();
		$this->NetBookValue->AdvancedSearch->unsetSession();
	...
	protected function loadSearchValues()
	{
		...
		// DepreciationAmount
		if (!$this->isAddOrEdit() && $this->DepreciationAmount->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->DepreciationAmount->AdvancedSearch->SearchValue != "" || $this->DepreciationAmount->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// DepreciationYtd
		if (!$this->isAddOrEdit() && $this->DepreciationYtd->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->DepreciationYtd->AdvancedSearch->SearchValue != "" || $this->DepreciationYtd->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// NetBookValue
		if (!$this->isAddOrEdit() && $this->NetBookValue->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->NetBookValue->AdvancedSearch->SearchValue != "" || $this->NetBookValue->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
	...
	public function getRowHash(&$rs)
	{
		...
		$hash .= GetFieldHash($rs->fields('DepreciationAmount')); // DepreciationAmount
		$hash .= GetFieldHash($rs->fields('DepreciationYtd')); // DepreciationYtd
		$hash .= GetFieldHash($rs->fields('NetBookValue')); // NetBookValue
		$hash .= GetFieldHash($rs->fields('Periode')); // Periode
