...
class t004_asset extends DbTable
{
	...
	public function __construct()
	{
		...
		// DepreciationAmount
		$this->DepreciationAmount = new DbField('t004_asset', 't004_asset', 'x_DepreciationAmount', 'DepreciationAmount', '`DepreciationAmount`', '`DepreciationAmount`', 4, 14, -1, FALSE, '`DepreciationAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DepreciationYtd
		$this->DepreciationYtd = new DbField('t004_asset', 't004_asset', 'x_DepreciationYtd', 'DepreciationYtd', '`DepreciationYtd`', '`DepreciationYtd`', 4, 14, -1, FALSE, '`DepreciationYtd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NetBookValue
		$this->NetBookValue = new DbField('t004_asset', 't004_asset', 'x_NetBookValue', 'NetBookValue', '`NetBookValue`', '`NetBookValue`', 4, 14, -1, FALSE, '`NetBookValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Periode
		$this->Periode = new DbField('t004_asset', 't004_asset', 'x_Periode', 'Periode', '`Periode`', CastDateFieldForLike("`Periode`", 7, "DB"), 133, 10, 7, FALSE, '`Periode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function renderEditRow()
	{
		...
		$this->Periode->EditValue = FormatDateTime($this->Periode->CurrentValue, 7);
