...
class t105_disposalhead extends DbTable
{
	...
	public function __construct()
	{
		...
		// property_id
		$this->property_id = new DbField('t105_disposalhead', 't105_disposalhead', 'x_property_id', 'property_id', '`property_id`', '`property_id`', 3, 11, -1, FALSE, '`property_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RecommendedBy
		$this->RecommendedBy = new DbField('t105_disposalhead', 't105_disposalhead', 'x_RecommendedBy', 'RecommendedBy', '`RecommendedBy`', '`RecommendedBy`', 3, 11, -1, FALSE, '`RecommendedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CE
		$this->CE = new DbField('t105_disposalhead', 't105_disposalhead', 'x_CE', 'CE', '`CE`', '`CE`', 3, 11, -1, FALSE, '`CE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ITM
		$this->ITM = new DbField('t105_disposalhead', 't105_disposalhead', 'x_ITM', 'ITM', '`ITM`', '`ITM`', 3, 11, -1, FALSE, '`ITM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Sign1
		$this->Sign1 = new DbField('t105_disposalhead', 't105_disposalhead', 'x_Sign1', 'Sign1', '`Sign1`', '`Sign1`', 3, 11, -1, FALSE, '`Sign1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Sign2
		$this->Sign2 = new DbField('t105_disposalhead', 't105_disposalhead', 'x_Sign2', 'Sign2', '`Sign2`', '`Sign2`', 3, 11, -1, FALSE, '`Sign2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Sign3
		$this->Sign3 = new DbField('t105_disposalhead', 't105_disposalhead', 'x_Sign3', 'Sign3', '`Sign3`', '`Sign3`', 3, 11, -1, FALSE, '`Sign3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
