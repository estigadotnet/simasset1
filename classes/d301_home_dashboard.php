 ...
 * Page class
 */
class d301_home_dashboard extends ReportTable
{
	...
	// Table name
	public $TableName = 'd301_home';

	// Page object name
	public $PageObjName = "d301_home_dashboard";
	...
	public function __construct()
	{
		...
		// Initialize
		$this->TableVar = 'd301_home';
		$this->TableName = 'd301_home';
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'd301_home');
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'd301_home');
			if ($Security->isLoggedIn())
