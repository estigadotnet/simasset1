 ...
 * Page class
 */
class t103_opname_view extends t103_opname
{
	...
	// Page object name
	public $PageObjName = "t103_opname_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t103_opnamelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t103_opnamelist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t103_opnamelist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
