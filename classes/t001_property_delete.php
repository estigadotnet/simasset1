 ...
 * Page class
 */
class t001_property_delete extends t001_property
{
	...
	// Page object name
	public $PageObjName = "t001_property_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t001_propertylist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t001_propertylist.php"); // Return to list
			}
		}
	}
