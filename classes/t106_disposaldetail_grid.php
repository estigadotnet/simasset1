 ...
 * Page class
 */
class t106_disposaldetail_grid extends t106_disposaldetail
{
	...
	// Page object name
	public $PageObjName = "t106_disposaldetail_grid";

	// Grid form hidden field names
	public $FormName = "ft106_disposaldetailgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "t105_disposalhead") {
			...
			if ($GLOBALS["t105_disposalhead"]->EventCancelled)
