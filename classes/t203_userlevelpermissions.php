...
/**
 * Table class for t203_userlevelpermissions
 */
class t203_userlevelpermissions extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't203_userlevelpermissions';
		$this->TableName = 't203_userlevelpermissions';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t203_userlevelpermissions`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new DbField('t203_userlevelpermissions', 't203_userlevelpermissions', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, 11, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tablename
		$this->_tablename = new DbField('t203_userlevelpermissions', 't203_userlevelpermissions', 'x__tablename', 'tablename', '`tablename`', '`tablename`', 200, 255, -1, FALSE, '`tablename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// permission
		$this->permission = new DbField('t203_userlevelpermissions', 't203_userlevelpermissions', 'x_permission', 'permission', '`permission`', '`permission`', 3, 11, -1, FALSE, '`permission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`t203_userlevelpermissions`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "t203_userlevelpermissionslist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "t203_userlevelpermissionsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t203_userlevelpermissionsadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("t203_userlevelpermissionsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t203_userlevelpermissionsview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "t203_userlevelpermissionsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "t203_userlevelpermissionsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t203_userlevelpermissionsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t203_userlevelpermissionsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t203_userlevelpermissionsdelete.php", $this->getUrlParm());
	}
	...
	{
		$table = 't203_userlevelpermissions';
		$usr = CurrentUserID();
