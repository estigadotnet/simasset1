...
class t102_ho_detail extends DbTable
{
	...
	public function __construct()
	{
		...
		// asset_id
		$this->asset_id = new DbField('t102_ho_detail', 't102_ho_detail', 'x_asset_id', 'asset_id', '`asset_id`', '`asset_id`', 3, 11, -1, FALSE, '`asset_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
