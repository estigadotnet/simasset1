 ...
 * Page class
 */
class t102_ho_detail_grid extends t102_ho_detail
{
	...
	// Page object name
	public $PageObjName = "t102_ho_detail_grid";

	// Grid form hidden field names
	public $FormName = "ft102_ho_detailgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "t101_ho_head") {
			$this->hohead_id->Visible = FALSE;
			if ($GLOBALS["t101_ho_head"]->EventCancelled)
