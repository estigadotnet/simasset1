...
<?php if ($t201_users_delete->EmployeeID->Visible) { // EmployeeID ?>
		<th class="<?php echo $t201_users_delete->EmployeeID->headerCellClass() ?>"><span id="elh_t201_users_EmployeeID" class="t201_users_EmployeeID"><?php echo $t201_users_delete->EmployeeID->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($t201_users_delete->_UserLevel->Visible) { // UserLevel ?>
		<th class="<?php echo $t201_users_delete->_UserLevel->headerCellClass() ?>"><span id="elh_t201_users__UserLevel" class="t201_users__UserLevel"><?php echo $t201_users_delete->_UserLevel->caption() ?></span></th>
<?php } ?>
...
<?php if ($t201_users_delete->EmployeeID->Visible) { // EmployeeID ?>
		<td <?php echo $t201_users_delete->EmployeeID->cellAttributes() ?>>
<span id="el<?php echo $t201_users_delete->RowCount ?>_t201_users_EmployeeID" class="t201_users_EmployeeID">
<span<?php echo $t201_users_delete->EmployeeID->viewAttributes() ?>><?php echo $t201_users_delete->EmployeeID->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($t201_users_delete->LastName->Visible) { // LastName ?>
...
<?php } ?>
<?php if ($t201_users_delete->_UserLevel->Visible) { // UserLevel ?>
		<td <?php echo $t201_users_delete->_UserLevel->cellAttributes() ?>>
<span id="el<?php echo $t201_users_delete->RowCount ?>_t201_users__UserLevel" class="t201_users__UserLevel">
<span<?php echo $t201_users_delete->_UserLevel->viewAttributes() ?>><?php echo $t201_users_delete->_UserLevel->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($t201_users_delete->Username->Visible) { // Username ?>
